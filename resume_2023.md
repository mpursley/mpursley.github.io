...
| :------------------------ | :------------------------
| &nbsp;             | • Design, plan and deploy product solutions using large Cloud Providers (AWS, GCP) and Microservices running Kubernetes (EKS, GKE), Terraform, Helm, Vault, Prometheus/Grafana, ELK, NoSQL, etc.
