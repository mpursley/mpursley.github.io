...
| &nbsp;             | • Worked with Systems Admins and Video Engineers to Design, Create and Test a 7 Node Linux Graphics Cluster for Interactive 3D and Digital Dailies playback in the Hayden Planetarium in preparation for the first upcoming full dome show. This system was based on non-proprietary, commodity-based hardware (Dual AMD64, Nvidia Quadro FX 4400, etc) and software (Linux, PiranhaHD).
| &nbsp;             | &nbsp;
