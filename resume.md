...
| :------------------------ | :------------------------
| &nbsp;             |
| &nbsp;             | • **Cloud Infrastructure & Deployment**: Design, plan and deploy product solutions using large Cloud Providers (AWS, GCP, Azure) and Microservices running Kubernetes (EKS, GKE), Terraform, Helm, Vault, Prometheus/Grafana, ELK and other OpenSource tools.
